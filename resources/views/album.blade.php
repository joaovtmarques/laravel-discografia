  ...
  <div class="w-4/5 sm:w-3/5 mt-28 shadow-lg pb-20 mb-20 h-auto">
    <div class="h-96">
      ...
      <div class="w-full h-full bg-white/80 sm:px-8 flex flex-col items-center justify-center">
        <form action="{{route('albums.store')}}" method="POST" class="w-4/5 sm:w-3/6">
         @csrf
          <div class="flex flex-col mb-8">
            ...
            <input
              ...
              name="name"
              id="name"
              class="h-12 px-4 rounded-3xl shadow-md outline-none font-aLight text-sm text-zinc-600 @error('name') border-2 border-red-500 @enderror"
            >
            @error('name')
              <div>
          ...
          <div class="flex flex-col mb-8">
            ...
            <input
              ...
              name="year"
              id="year"
              class="h-12 px-4 rounded-3xl shadow-md outline-none font-aLight text-sm text-zinc-600 @error('year') border-2 border-red-500 @enderror"
